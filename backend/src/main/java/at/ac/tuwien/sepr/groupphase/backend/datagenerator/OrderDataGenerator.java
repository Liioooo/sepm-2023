    ...
    protected List<Order> generate() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            autoGeneratedOrders.add(Order.builder()
                ...
                .orderType(orderTypes[faker.number().numberBetween(0, 1)])
                .user(userDataGenerator.getTestData().get(faker.number().numberBetween(0, 10)))
                .event(eventDataGenerator.getTestData().get(faker.number().numberBetween(0, 1000)))
                .build()
            );
        }
